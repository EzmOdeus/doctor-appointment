            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section style={{ paddingBottom: "20px" }}>
                        <Row>
                            <Text style={heading}>HI {response.data.UserName} </Text>
...
EmailTemp.PreviewProps = {
    authorName: "Spider",
    authorImage: `${baseUrl}/Logo.svg`,
    reviewText: `“Spider Healthy”`,
} as EmailTempProps;

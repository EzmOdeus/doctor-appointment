...
function Services() {
    return (
        <div className="grid grid-cols-5 gap-10 py-32 justify-items-center items-center">
            ...
            <div className="md:col-span-3 col-span-5 px-6 ">
                <h2 className='text-5xl pb-3 font-extrabold text-center'>Our
                    Special Services</h2>
                <p className='text-xl text-gray-500/50 md:px-[20%] pb-3 text-center'>In times like today, your health is very important,
                ...
                <div className="grid gap-6 grid-cols-2 pt-3">
                    <div className="">
                        ...
                        <p className='md:w-[80%] text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ornare tellus malesuada odio blandit. Sit duis eu nisi habitant lorem egestas. </p>
                    </div>
                    <div className="">
